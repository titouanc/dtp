...
import be.ac.ulb.infof307.g03.utils.parser.TestObjParser;
import be.ac.ulb.infof307.g03.controllers.TestControllers;

@RunWith(Suite.class)
@SuiteClasses({ TestMain.class, TestModels.class, TestControllers.class, TestObjParser.class, Test3DSParser.class})
